...
public class GuiAltManager extends GuiScreen {
    ...
    @Override
    public void initGui() {
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4, "Login"));
        this.buttonList.add(new GuiButton(1, 5, this.height - 25, "Back"));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, this.height / 4 + 30, "Alts List"));
